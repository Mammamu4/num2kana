 ...
 */
export function numToKana(num, options) {
    if (num < 0 || num > 1e20) {
        throw new Error("Number is not within range: 0 <= num <= 10^20");
    }
...
function calculateMyriadGroupValue(num, groupIndex, myriadValue) {
    if (groupIndex === 0) {
...
export function numToKanji(num, options) {
    return numToKana(num, { ...options, type: "kanji" });
}
export function numToHiragana(num, options) {
    return numToKana(num, { ...options, type: "hiragana" });
}
export function numToKatakana(num, options) {
    return numToKana(num, { ...options, type: "katakana" });
}
export function numToRomaji(num, options) {
    return numToKana(num, { ...options, type: "romaji" });
}
export function numToAllFormats(num, options) {
    return {
